...
| **`cross_newspaper_comparison`** | Comparative coverage, framing differences, or contrasting editorial perspectives. | `coverage_analyzer` | `hybrid_search` | Side-by-side comparison matrix of publication perspectives. |
