...
def is_structural_or_relevant_evidence(item: dict[str, Any], archetype: str) -> bool:
    ...
    """
    return (
        archetype in ("cross_newspaper_comparison", "quantitative_trend", "article_catalog")
...
class EvidenceEvaluator:
    ...
    async def evaluate_and_fallback(
        ...
        if not has_grounded_content:
            ...
            # 1. Fallback: Entity Search if a capitalized entity candidate is detected in the query
